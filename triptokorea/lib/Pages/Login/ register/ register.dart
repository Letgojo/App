...
class _registerState extends State<register> {
  ...
  Widget build(BuildContext context) {
    return Consumer<registerSerivce>(
        builder: (context, registerSerivce, child) {
      return Scaffold(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (IdController.text.isNotEmpty &&
                          ...
                          registerSerivce.create(IdController.text, name.text,
                              PwdController.text, ninkname.text, poneNum.text);
                          Navigator.push(
                              context,
                              MaterialPageRoute(
